...
func (usq *UserSettingsQuery) FirstIDX(ctx context.Context) int64 {
...
func (usq *UserSettingsQuery) OnlyIDX(ctx context.Context) int64 {
...
func (usq *UserSettingsQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (usq *UserSettingsQuery) IDsX(ctx context.Context) []int64 {
	ids, err := usq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (usq *UserSettingsQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserSettings, init func(*UserSettings), assign func(*UserSettings, *User)) error {
	...
	nodeids := make(map[int64][]*UserSettings)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (usq *UserSettingsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usersettings.Table, usersettings.Columns, sqlgraph.NewFieldSpec(usersettings.FieldID, field.TypeInt64))
	_spec.From = usq.sql
	...
	if fields := usq.ctx.Fields; len(fields) > 0 {
		...
		if usq.withUser != nil {
			_spec.Node.AddColumnOnce(usersettings.FieldUserID)
		}
	}
