...
require (
	...
	gitlab.calendaria.team/services/contacts v1.1.1
	gitlab.calendaria.team/services/notifications v0.1.1
...
require (
	...
	gitlab.calendaria.team/services/events v0.1.2 // indirect
