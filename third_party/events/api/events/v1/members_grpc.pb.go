...
const (
	Members_InviteMembers_FullMethodName      = "/api.events.v1.Members/InviteMembers"
	Members_UpdateMemberStatus_FullMethodName = "/api.events.v1.Members/UpdateMemberStatus"
	Members_UpdateMemberRemind_FullMethodName = "/api.events.v1.Members/UpdateMemberRemind"
	Members_UpdateMemberRole_FullMethodName   = "/api.events.v1.Members/UpdateMemberRole"
	Members_KickMember_FullMethodName         = "/api.events.v1.Members/KickMember"
	Members_GetMember_FullMethodName          = "/api.events.v1.Members/GetMember"
	Members_ListMembers_FullMethodName        = "/api.events.v1.Members/ListMembers"
	Members_GetMemberHistory_FullMethodName   = "/api.events.v1.Members/GetMemberHistory"
)
...
func (c *membersClient) GetMemberHistory(ctx context.Context, in *GetMemberHistoryRequest, opts ...grpc.CallOption) (*GetMemberHistoryReply, error) {
	...
	err := c.cc.Invoke(ctx, Members_GetMemberHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Members_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.events.v1.Members",
	...
	Metadata: "events/v1/members.proto",
}
