...
func _Settings_GetSettings0_HTTP_Handler(srv SettingsHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetSettings(ctx, req.(*v1.EmptyRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type SettingsHTTPClient interface {
	GetSettings(ctx context.Context, req *v1.EmptyRequest, opts ...http.CallOption) (rsp *SettingsReply, err error)
...
func (c *SettingsHTTPClientImpl) GetSettings(ctx context.Context, in *v1.EmptyRequest, opts ...http.CallOption) (*SettingsReply, error) {
