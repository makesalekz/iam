...
const (
	...
	Auth_RefreshPersonalToken_FullMethodName = "/api.iam.v1.Auth/RefreshPersonalToken"
	Auth_RefreshTenantToken_FullMethodName   = "/api.iam.v1.Auth/RefreshTenantToken"
)
...
func (c *authClient) RefreshPersonalToken(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*TokenReply, error) {
	out := new(TokenReply)
...
func (UnimplementedAuthServer) RefreshPersonalToken(context.Context, *EmptyRequest) (*TokenReply, error) {
...
func _Auth_RefreshPersonalToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RefreshPersonalToken(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
