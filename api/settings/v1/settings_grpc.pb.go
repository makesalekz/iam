...
const (
	Settings_GetSettings_FullMethodName    = "/api.settings.v1.Settings/GetSettings"
	Settings_UpdateSettings_FullMethodName = "/api.settings.v1.Settings/UpdateSettings"
)
